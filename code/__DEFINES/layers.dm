...
#define LOW_FLOOR_LAYER (1)
#define TURF_PLATING_DECAL_LAYER (2)
#define TURF_DECAL_LAYER (3) //Makes turf decals appear in DM how they will look inworld.
#define CULT_OVERLAY_LAYER (4)
#define MID_TURF_LAYER (5)
#define HIGH_TURF_LAYER (6)
#define LATTICE_LAYER (7)
#define DISPOSAL_PIPE_LAYER (8)
#define WIRE_LAYER (9)
#define GLASS_FLOOR_LAYER (10)
#define TRAM_RAIL_LAYER (11)
#define ABOVE_OPEN_TURF_LAYER (12)
///catwalk overlay of /turf/open/floor/plating/catwalk_floor
#define CATWALK_LAYER (13)
